...
that, though it means that Boson Protocol follows the norms and values of open
...
There's several ways to get involved in the Boson Protocol ecosystem. First, we
encourage deep dives into the code, and both pull requests and issues from
anyone in the community. If you have a question, a bug report, or a feature
request - open an issue and share your thoughts. As well, we have an active
